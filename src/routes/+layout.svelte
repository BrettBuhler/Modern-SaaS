<script lang="ts">
	...
	import { Navbar, NavBrand, NavHamburger, NavUl, NavLi, Button, Dropdown, DropdownItem, Chevron } from "flowbite-svelte";
		...
		<div class="flex md:order-2">
			...
			<Dropdown>
				...
				<form action="/logout" method="POST">
					<DropdownItem slot="footer" type="submit">Sign out</DropdownItem>
				</form>
			</Dropdown>
			{:else}
